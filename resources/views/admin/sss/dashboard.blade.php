    ...
    <div class="templatemo-content-container">
        ...
        <div class="col-1">
            <div class="panel panel-default margin-10">
                <div class="panel-heading"><h2 class="text-uppercase">S.S.S EKLE</h2></div>
                <div class="panel-body">
                    <form action="{{route('admin.sss.add.post')}}" enctype="multipart/form-data" method="POST" class="templatemo-login-form">
                        {{csrf_field()}}
