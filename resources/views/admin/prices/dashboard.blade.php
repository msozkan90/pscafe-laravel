    ...
    <div class="templatemo-content-container">
        ...
        <div class="col-1">
            <div class="panel panel-default margin-10">
                <div class="panel-heading"><h2 class="text-uppercase">Fİyat Ekle</h2></div>
                <div class="panel-body">
                    <form action="{{route('admin.prices.add.post')}}" enctype="multipart/form-data" method="POST" class="templatemo-login-form">
                        {{csrf_field()}}
                        ...
                        <div class="form-group">
                            <button type="submit" class="templatemo-blue-button">Fİyat Ekle</button>
                        </div>
