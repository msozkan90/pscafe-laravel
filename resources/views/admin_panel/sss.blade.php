...
<html lang="en">
  ...
  <body>
    ...
    <div class="templatemo-flex-row">
      <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">
          <ul>
            <li><a href="{{route('admin.admin_panel.index')}}"><i class="fa fa-home fa-fw"></i>Dashboard</a></li>
      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            ...
            <form action="{{route('admin.admin_panel.index')}}" class="templatemo-login-form" method="post" enctype="multipart/form-data">
    ...
    <script type="text/javascript" src="{{asset('admin_panel/assets/js/bootstrap-filestyle.min.js)}}"></script>  <!-- http://markusslima.github.io/bootstrap-filestyle/ -->
